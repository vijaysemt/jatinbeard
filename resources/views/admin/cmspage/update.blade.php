            ...
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Update <span
                            class="text-danger text-decoration">{{ $data['name'] }}</span> Category info:-</h4>
                    <!-- start  -->
                    <form action="{{ url('updatecmspageinfo', $data->id) }}" method="post"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    <label for="">Order* <span
                                            class="font-weight-bold text-danger text-uppercare mark">
                                            {{ $data['order'] }}
                                        </span>
                                    </label>
                                        ...
                                        <option
                                            ...
                                            @if ($data['status'] == 1)
                                                <span class="font-weight-bold text-primary">
                                                    @php
                                                        echo 'Visible!!' . '- Old Selected Status';
                                                    @endphp
                                                </span>
                                            @else
                                                <span class="font-weight-bold text-danger">
                                                    @php
                                                        echo 'Hidden!!' . '- Old Selected Status';
                                                    @endphp
                                                </span>
                                            @endif
                                        </option>
