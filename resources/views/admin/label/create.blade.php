        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Add New Label:-</h4>
                    <!-- start  -->
                    <form action="{{ url('addlabelinfo') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="color-picker-container">
                                        ...
                                        <input type="text" name="colorcode" class="w-75"  id="foregroundHexValue"readonly>
                                    </div>
