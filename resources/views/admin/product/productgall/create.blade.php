        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Add New Product Gallery:-</h4>
                    <!-- start  -->
                    <form action="{{ url('addpgalleryinfo')}}" method="post" enctype="multipart/form-data" class="form-validation">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    <label for="">Name*</label>
                                    <input type="text" class="form-control" required name="alt">
                                </div>
                            </div>

                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    <label for="">Choose Product Related*</label>
                                    <select class="form-control" name="pid" required data-toggle="select2">
                                        <option value="">Choose Product Related</option>
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    <h5 class="font-weight-bold text-danger">Product Gallery image</h5>
                                    <input type="file" class="filestyle" required  name="pimage">
                                </div>
                            </div>
