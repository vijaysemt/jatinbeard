        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Add New Slider:-</h4>
                    <!-- start  -->
                    <form action="{{ url('addsliderinfo')}}" method="post" enctype="multipart/form-data" class="form-validation">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    <h5 class="font-weight-bold text-danger">Home page slider image</h5>
