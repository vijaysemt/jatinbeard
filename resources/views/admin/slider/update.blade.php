        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    ...
                    <!-- start  -->
                    <form action="{{ url('updatesliderinfo',$data->id)}}" method="post" enctype="multipart/form-data" class="form-validation">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="form-group">
                                    ...
                                    <img src="{{ url('admin/assets/uploads/slider/'.$data->image) }}" alt="" width="50px" class=" pr-3">
