        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Update <span class="text-danger text-decoration">{{$data['name']}}</span> Category info:-</h4>
                    <!-- start  -->
                    <form action="{{ url('updatecategoryinfo',$data->id)}}" method="post" enctype="multipart/form-data" class="form-validation">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="shortdescription" id="editor1" rows="10" cols="80"> {{$data['shortdescription']}}</textarea>
                                    <script>
                                        // Initialize CKEditor
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="fulldescription" id="editor2" rows="10" cols="80"> {{$data['fulldescription']}}</textarea>
                                    <script>
                                        // Initialize CKEditor
                            ...
                            <div class="col-lg-12 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  value="{{$data['metatitle']}}" name="metatitle">
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    <h5 class="font-weight-bold text-danger">Home page Category image</h5>
                                    <img src="{{ url('admin/assets/uploads/category/home/'.$data->image) }}" alt="" width="50px" class=" pr-3">
                                    <input type="file" class="filestyle" name="image">
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    <h5 class="font-weight-bold text-danger">Category page cover image</h5>
                                    <img src="{{ url('admin/assets/uploads/category/home/'.$data->image) }}" alt="" width="50px" class=" pr-3">
