        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 p-md-5 p-4 border rounded mb-4">
                    <h4 class="font-weight-bold mb-3">Add New Category:-</h4>
                    <!-- start  -->
                    <form action="{{ url('addcategoryinfo')}}" method="post" enctype="multipart/form-data" class="form-validation">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="shortdescription" id="editor1" rows="10" required cols="80"></textarea>
                                    <script>
                                        // Initialize CKEditor
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group">
                                    <label for="">Full Description*</label>
                                    <textarea name="fulldescription" id="editor2" rows="10" required cols="80"></textarea>
                                    <script>
                                        // Initialize CKEditor
