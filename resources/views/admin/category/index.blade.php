                                    ...
                                    <tbody>
                                        ...
                                        @foreach (App\Models\Category::get() as $date)
                                            ...
                                            <tr>
                                                <td>{{ $sr }}</td>
                                                <td>
                                                    <img src="{{ url('admin/assets/uploads/category/home/' . $date->image) }}"
                                                        alt="" width="50px">
                                                </td>
                                                <td>
                                                    <img src="{{ url('admin/assets/uploads/category/cover/' . $date->cover) }}"
                                                        alt="" width="80px">
                                                </td>
                                                <td>{{ $date->name }}</td>
                                                <td> {{ $date->order }} </td>
                                                ...
                                                <td>
                                                    <a href="{{ url('updatecategory/' . $date->id . '/edit') }}">
                                                        <span class="btn btn-success btn-sm">
                                                            <i class="far fa-edit"></i> Update
                                                        </span>
                                                    </a>
                                                    <a href="{{ url('deletecategory/' . $date->id . '/delete' ) }}">
